...
- **Software Developer – SLOG Solutions, Dehradun (2025–present)**  
  - Built a **secure offline Exam & Evaluation Portal** for the Indian Army.  
  - Developing a **fitness evaluation system** for army trainees.  
  - Focus: **security-first design** with encrypted `.dat` file transfers.  
...
- **Face Detection with OpenCV** (2023)  
  Real-time multiple face detection using Haar Cascades.  
  *Tech: Python, OpenCV*  

- **Yoga Pose Detection** (2023)  
  Classified yoga poses using **MediaPipe Pose Estimation** and joint angle calculations.  
...
- Data Analytics using Tableau (Deloitte)  
- Web Development  

---

## 🌱 Extra-Curricular
- Core Committee Member – *Kavyanjali Literature Club* (2022–2024)  
- Lead Organizer – *University Tech-Fest*  
